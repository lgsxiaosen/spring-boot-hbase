package com.gsliu.hbase.service.impl;

import com.gsliu.hbase.configuration.HbaseConfig;
...
public class HbaseServiceImpl implements HbaseService {
    ...
    public boolean createTable(String tableName, List<String> columnFamily) {
        try(Admin admin = HbaseConfig.connection.getAdmin()) {
    ...
    private Table getTable(String tableName) throws IOException {
        return HbaseConfig.connection.getTable(TableName.valueOf(tableName));
    }
...
//            table.close();
    ...
    public static void close() {
        if (HbaseConfig.connection != null) {
            try {
                HbaseConfig.connection.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
